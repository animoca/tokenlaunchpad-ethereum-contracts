...
import {IERC165, ERC20} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC20/ERC20.sol";
import {IERC20Mintable} from "@animoca/ethereum-contracts-assets-2.0.0/contracts/token/ERC20/IERC20Mintable.sol";
import {MinterRole} from "@animoca/ethereum-contracts-core-1.1.2/contracts/access/MinterRole.sol";

/**
 * @title UMAD Mock. 8 decimals
 */
contract UMADMock is Recoverable, UsingUniversalForwarding, ERC20, IERC20Mintable, MinterRole {
    constructor(
        address[] memory recipients,
        uint256[] memory values,
        IForwarderRegistry forwarderRegistry,
        address universalForwarder
    ) ERC20("UMAD Mock", "UMAD", 8) MinterRole(msg.sender) UsingUniversalForwarding(forwarderRegistry, universalForwarder) {
